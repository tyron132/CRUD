...
<body>
    ...
    if (!empty($_POST)) {
        try {
            $sql = "UPDATE movies SET title =?, synopsis=? WHERE id=?";
            $req = $pdo->prepare($sql);
            $req->execute([$_POST['title'], $_POST['synopsis'], $_GET['id']]);
                ...
                <div class="col-sm-4 mx-auto">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo $film->title ?>" name="title" id="title" class="form-control" />
                        </div>
                        <div class="form-group">
